...
CONFIGS_TESTED = [
    ...
    "o servico voltar.",
    "*** SPREAD MEDIDO NA JANELA DO BACKTEST -- o bloqueio acima estava "
    "PARCIALMENTE errado, e a correcao muda o resultado do h=5. *** "
    "O download que fora dado como falho tinha sucedido em parte antes de "
    "morrer: 26 boletins de 2021-2023 estavam em cache sem que ninguem "
    "notasse (5 de 2021, 15 de 2022, 6 de 2023). O endpoint da B3 esta "
    "INTERMITENTE, nao uniformemente quebrado para datas antigas -- a "
    "afirmacao anterior fica corrigida. Esses 26 pregoes rendem 716 series-dia "
    "com negocio, contra 988 em 78 pregoes de 2026: a liquidez de 2021-2023 e "
    "~4x maior por dia, exatamente como o registro de queda de liquidez previa. "
    "MEDICAO NA FAIXA QUE DECIDE (3-12 dias, o prazo que o h=5 opera): "
    "2021-2023 mediana 8,51% (n=29, p25 4,54%, p75 19,71%) contra 17,12% em "
    "2026 (n=20). METADE. A previsao registrada -- 'a medicao de 2026 "
    "provavelmente SUPERESTIMA o spread da janela do backtest' -- se confirma, "
    "e agora e medicao, nao raciocinio. Nas demais faixas de prazo os dois "
    "periodos praticamente coincidem (4,87% vs 4,43%), entao a diferenca esta "
    "concentrada no prazo CURTO, que e onde a opcao de 2026 quase nao negocia. "
    "RESULTADO DO h=5 COM O SPREAD CORRETO: Sharpe +1.691, IC95 "
    "[-0.23, +3.51], p=0.079 (contra +0.558, p=0.54 com o spread de 2026). "
    "Sensibilidade: sem custo +2.823 (p=0.008); p25 +2.218 (p=0.029); "
    "p75 +0.222 (p=0.807). "
    "A CONCENTRACAO TAMBEM MELHOROU, e essa era a objecao mais forte: os 3 "
    "maiores ganhos passam de 174% do P&L total (onde remove-los tornava o "
    "resultado NEGATIVO) para 61,8%, e sem eles o Sharpe ainda e +0.823. "
    "Acerto 56,4%, assimetria +0.49 -- a patologia de cauda esquerda que "
    "dominava o h=21 nao aparece aqui. Por ano: +3.70 / +2.15 / +2.05 / +0.96 "
    "/ -6.38 (2023, n=5). "
    "*** MESMO ASSIM NAO PASSA NO CRITERIO DECLARADO: o portao era IC95 "
    "excluindo zero pelo lado positivo, e o IC vai de -0.23 a +3.51. p=0.079 "
    "nao e p<0.05. O criterio NAO sera afrouxado depois de ver o numero. *** "
    "RESSALVAS QUE CONTINUAM: (a) a anualizacao supoe 50 operacoes/ano e a "
    "cobertura de IV so sustenta 13,4 -- com a frequencia REALIZAVEL o Sharpe "
    "e +0.865, nao +1.691; (b) 29 observacoes de spread, e o p75 delas "
    "(19,71%) leva o Sharpe a +0.22; (c) 2023 colapsa; (d) os 26 pregoes "
    "vieram de um download que falhou no meio, entao nao sao amostra aleatoria "
    "do periodo -- e sucesso de download nao deveria correlacionar com spread, "
    "mas nao foi verificado. "
    "STATUS: o resultado economicamente mais forte que o projeto produziu, e "
    "ainda assim NAO ESTABELECIDO. O que o fecharia e mais boletim de "
    "2019-2023, que agora se sabe ser obtenivel com retentativa.",
]
